...
// Batched 8-way Keccak-f1600 permutation for SHA3
// Inputs a[200], rc[24]; output a[200]
extern void sha3_keccak8_f1600_avx512(uint64_t a[S2N_BIGNUM_STATIC 200],const uint64_t rc[S2N_BIGNUM_STATIC 24]);
#endif
